...
//@BindingAdapter(SPINNER_ERROR_MSG_ATTRIBUTE)
//fun MaterialSpinner.setSpinnerError(errorMsg:String?){
//    error= errorMsg
//}
//
//@BindingAdapter(SPINNER_ERROR_MSG_ATTRIBUTE)
//fun MaterialSpinner.setSpinnerError(errorMsg:Int?){
//    error= errorMsg?.toStringResource(context)
//}
