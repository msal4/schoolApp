...
class GetExamQuestionsWithAnswersUseCase @Inject constructor(
    ...
    private fun transformFlows(
        ...
        val answerableQuestions: ListOfAnswerableQuestions =
            ...
            Resource.Status.SUCCESS -> {
                when (answersResource.status) {
                    ...
                    Resource.Status.ERROR -> {
                        Resource.error(
                            questionsResource.message.toString(),
                            data = answerableQuestions
                        )
                    }
    ...
    private fun combineQuestionsAndAnswers(
        questions: List<Question>,
        answers: ListOfAnswers?
    ): ListOfAnswerableQuestions {
        return questions.mapIndexed { index, question ->
            BaseAnswerableQuestion.fromQuestionAnswer(
                question = question,
